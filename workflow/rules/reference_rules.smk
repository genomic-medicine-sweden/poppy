...
rule reference_rules_create_artifact_file_pindel:
    ...
    resources:
        ...
        mem_per_cpu=config.get("reference_rules_create_artifact_file_pindel", {}).get("mem_per_cpu", config["default_resources"]["mem_per_cpu"]),
        partition=config.get("reference_rules_create_artifact_file_pindel", {}).get("partition", config["default_resources"]["partition"]),
        threads=config.get("reference_rules_create_artifact_file_pindel", {}).get("threads", config["default_resources"]["threads"]),
