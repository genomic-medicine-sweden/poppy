...
**Description:** Annotate VCF files with VEP (Docker image `hydragenetics/vep:116.1`) and/or custom annotations such as artifact and background annotation from the reference pipeline.
**Key Outputs**
